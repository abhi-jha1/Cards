    ...
    return (
      <div className='credit-card'>
        ...
        <form style={{ textAlign: "center" }}>
          ...
          <input className="input1" type="text" pattern="[0-9]*" placeHolder="MM / YY" maxLength='4' onInput={this.validate5} value={this.state.value5} />
          <input className="input" type="text" pattern="[0-9]*" placeHolder='cvv' pattern="[0-9]*" onInput={this.validate6} value={this.state.value6} maxLength='3' />
